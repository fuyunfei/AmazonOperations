...
│  ├── 每个 Session 运行 Agent Loop（基于 Anthropic SDK stream）    │
...
| [04-Agent架构](architecture/04-Agent架构.md) | Agent Loop + Skill 系统 + SSE 规范 |
...
| 数据库 | SQLite (Prisma) |
| AI | `@anthropic-ai/sdk` v0.36.3（手写 Agent Loop + stream） |
